    ...
    <div class="wrapper">
      ...
      <div class="right-wrapper">
        ...
        <span
          ...
          >登录/注册</span
        >
        <el-dropdown v-if="name != ''" @command="loginMenu" trigger="click">
          ...
          <el-dropdown-menu class="user-name-wrapper" slot="dropdown">
            ...
            <el-dropdown-item command="ß/logout" divided
...
export default {
  ...
  mounted() {
    ...
    //   document.getElementById("loginDialoßg").click();
    // });
