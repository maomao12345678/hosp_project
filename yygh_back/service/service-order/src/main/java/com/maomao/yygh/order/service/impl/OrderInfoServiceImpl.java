...
import com.maomao.yygh.order.mapper.OrderInfoMapper;
...
import com.maomao.yygh.vo.order.*;
import com.maomao.yygh.fegin.HospitalFeignClient;
import com.maomao.yygh.fegin.PatientFeignClient;
...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderInfoService {
    ...
    public Map<String, Object> getCountMap(OrderCountQueryVo orderCountQueryVo) {
        ...
        //日期列表,画图中x轴的数据(获取数据中只是日期的list)
        List<String> dateList = orderCountVoList.stream().map(OrderCountVo::getReserveDate).collect(Collectors.toList());
        //统计列表,画图中y轴的数据(获取数据中只是订单数的list)
